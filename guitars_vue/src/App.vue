  ...
  <nav class="navbar is-dark">
    ...
    <!-- //search -->
      <div class="navbar-end">
        <router-link to="/acoustic" class="navbar-item">Акустические</router-link>
        <router-link to="/electric" class="navbar-item">Электрогитары</router-link>
        <router-link to="/classic" class="navbar-item">Классические</router-link>
        <router-link to="/bass" class="navbar-item">Бас-гитары</router-link>
    <!-- my-account -->
      <div class="navbar-item">
        <div class="buttons">
